...
CREATE TABLE CTHD (
	...
	CONSTRAINT FK_CTHD_MAMON FOREIGN KEY (MAMON) REFERENCES MON (MAMON) ON DELETE CASCADE SET NULL) 
...
ALTER TABLE CTHD
DROP CONSTRAINT FK_CTHD_MAMON

ALTER TABLE CTHD
ADD CONSTRAINT FK_CTHD_MAMON FOREIGN KEY  (MAMON) REFERENCES MON (MAMON) ON DELETE SET NULL